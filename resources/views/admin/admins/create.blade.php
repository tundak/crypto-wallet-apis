  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        {!! Form::model($admin, [ 'method' => 'post', 'route' => ['admins.store'], 'class'=>"form-horizontal",'id'=>'adminForm' ]) !!}
          <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                {!! Form::select('role_id[]', $roles , null,['required' => 'required','class'=>'form-control select2', 'multiple'=>'multiple'])!!}
                @if ($errors->has('name'))
                    <span class="has-error">
